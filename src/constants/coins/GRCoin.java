...
public class GRCoin extends Coin {
    
    private final String GRCoinIPS = "patches/GRCoin.ips";
    
    public GRCoin(RandomAccessFile f) {
        super(f);
    }
    ...
    public void AlterCoinHeads() throws IOException
    {
        ...
        URL ipsURL = GRCoin.class.getClassLoader().getResource(GRCoinIPS);
