...
import static constants.Cards.Articuno2;
import static constants.Cards.Bulbasaur;
import static constants.Cards.Charmander;
import static constants.Cards.Dragonite2;
import static constants.Cards.Mew3;
import static constants.Cards.Moltres2;
import static constants.Cards.Pidgey;
import static constants.Cards.Pikachu1;
import static constants.Cards.Pinsir;
import static constants.Cards.Sandshrew;
import static constants.Cards.Squirtle;
import static constants.Cards.Zapdos3;
...
class ProgramLogic {
    ...
    //         Utils.initTo(bbWrite, i, CardFields.NAME);
    //         //String name = bbWrite.

    //         Utils.initTo(bbWrite, i, CardFields.MOVE1);

    //         //If nothing else, just pass the normal array through
    //         bbPostWrite.put(bbWrite.array(), bbWrite.position(), Constants.PKMN_MOVE_DATA_LENGTH);

    //         Utils.initTo(bbWrite, i, CardFields.MOVE2);
